      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              <div className="md:w-1/2 text-center md:text-left">
                ...
                <Link href="/presupuesto-rapido" className="w-full md:w-auto">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-10 py-6 text-sm font-semibold tracking-wide w-full md:w-auto uppercase">
                    COMENZAR AHORA
                  </Button>
                </Link>
              </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href="/contacto">
              <Button className="bg-white text-blue-600 hover:bg-blue-50 rounded-full px-10 py-6 text-lg font-semibold">
