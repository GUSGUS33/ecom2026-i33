...
const TransactionalPage = lazy(() => import("./pages/TransactionalPage"));
const ThankYouCardPage = lazy(() => import("./pages/ThankYouCardPage"));
const ThankYouTransferPage = lazy(() => import("./pages/ThankYouTransferPage"));
...
function Router() {
  ...
  return (
    <MainLayout>
      {/* Redirección automática para trailing slash (SEO) */}
      ...
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/pedido-confirmado/tarjeta">
            {() => (
              <RequireAuth>
                <ThankYouCardPage />
              </RequireAuth>
          ...
          <Route path="/pedido-confirmado/transferencia">
            {() => (
              <RequireAuth>
                <ThankYouTransferPage />
              </RequireAuth>
            )}
          </Route>
          ...
          {/* NOTA: Las páginas transaccionales desde WordPress tienen prioridad */}
          {/* Si una página existe en WP con plantilla transaccional, se renderiza con TransactionalPage */}
          {/* Si no, se usa CategoryPage como fallback */}
          <Route path="/:category" component={TransactionalPage} />
          <Route path="/:category/:subcategory" component={TransactionalPage} />
          <Route path="/:category/:subcategory/:child" component={TransactionalPage} />
